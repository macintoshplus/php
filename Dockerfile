...
# PHP
RUN     apt-get -y install php7-cli php7-curl php-soap php7-imagick php7-gd php7-mcrypt php7-mysql php7-xmlrpc php7-xsl php7-xdebug php-apc php7-apcu php7-ldap php7-gmp php7-intl php7-redis
